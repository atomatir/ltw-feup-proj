<form action="" method="post">
  <input type="text" name="title" id="place-title">
  <textarea name="desc" id="place-desc" cols="10" rows="10"></textarea>
  <input type="number" name="bathrooms" id="place-bathrooms">
  <input type="number" name="bedrooms" id="place-bedrooms">
