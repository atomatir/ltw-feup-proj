...
<form id="place-form" action="" method="post">
  <div id="place-div">
    ...
    <input type="number" name="price_by_nigth" id="place-price" min=0 class="input" placeholder="Price per night">
  </div>
  <div id='address-div'>
    <input type="number" name="latitude" id="place-lat" class="input" placeholder="Price per night">
    <input type="number" name="longitude" id="place-long" class="input">
    ...
    <input type="number" name="postal_code" id="place-long" class="input" >
