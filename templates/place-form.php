...
<form id="place-form" action="" method="post">
  ...
  <div id="place-div">
    ...
    <input    id="place-beds"   type="number" name="bedrooms"       min=0 class="input" placeholder="Bedrooms" required>
    <input    id="place-baths"  type="number" name="bathrooms"      min=0 class="input" placeholder="Bathrooms" required>
